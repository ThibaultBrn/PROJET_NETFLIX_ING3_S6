...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 16 avr. 2023 à 20:38
...
CREATE TABLE IF NOT EXISTS `casting` (
  ...
  `PrenomActeur` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`NomFilm`,`NomActeur`,`PrenomActeur`),
  KEY `NomFilm` (`NomFilm`)
...
INSERT INTO `casting` (`NomFilm`, `NomActeur`, `PrenomActeur`) VALUES
('Aquaman', 'Affleck', 'Ben'),
('Aquaman', 'Dafde', 'Willem'),
('Aquaman', 'Heard', 'Amber'),
('Aquaman', 'Momoa', 'Jason'),
('Aquaman', 'Wann', 'James'),
('Avatar', 'Saldana', 'Zoe'),
('Avatar', 'Worthington', 'Sam'),
('Avengers: Endgame', 'Downey Jr.', 'Robert'),
('Avengers: Endgame', 'Evans', 'Chris'),
('Blade Runner', 'Ford', 'Harrison'),
('Blade Runner', 'Hauer', 'Rutger'),
('Fight Club', 'Bonham Carter', 'Elena'),
('Fight Club', 'Norton', 'Edward'),
('Fight Club', 'Pitt', 'Brad'),
('Get Out', 'Kaluuya', 'Daniel'),
('Get Out', 'Williams', 'Allison'),
('Inception', 'Di Caprio', 'Leonardo'),
('Inception', 'Hardi', 'Tom'),
('Interstellar', 'Chastain', 'Jessica'),
('Interstellar', 'McCaunoghey', 'Matthew'),
('John Wick', 'Reeves', 'Keanu'),
('John Wick', 'Robbie', 'Margot'),
('John Wick', 'Skarsgard', 'Bill'),
('John Wick', 'Yen', 'Donni'),
('Le loup de Wall Street', 'Di Caprio', 'Leonardo'),
('Le Parrain', 'Brando', 'Marlon'),
('Le Parrain', 'Pacino', 'Al'),
('Les insurgés', 'Bell', 'Jamie'),
('Les insurgés', 'Craig', 'Daniel'),
('Pulp Fiction', 'Travolta', 'John'),
('Pulp Fiction', 'Willis', 'Bruce'),
('Red Army', 'Bowman', 'Scotty'),
('Red Army', 'Fetisov', 'Slavia'),
('Seven', 'Freeman', 'Morgan'),
('Seven', 'Pitt', 'Brad'),
('Shrek 2', 'Murphy', 'Eddie'),
('Shrek 2', 'Myers', 'Mike'),
('Tenet', 'Pattinson', 'Robert'),
('Tenet', 'Washington', 'John David'),
('Usual Suspects', 'Byrne', 'Gabriel'),
('Usual Suspects', 'Spacey', 'Kevin');
...
('Avengers: Endgame', 182, 'https://www.youtube.com/watch?v=wV-Q0o2OQjQ', 'Le Titan Thanos, ayant réussi à s\'approprier les six Pierres d\'Infinité et à les réunir sur le Gantelet doré, a pu réaliser son objectif de pulvériser la moitié de la population de l\'Univers. Cinq ans plus tard, Scott Lang, alias Ant-Man, parvient à s\'échapper de la dimension subatomique où il était coincé. Il propose aux Avengers une solution pour faire revenir à la vie tous les êtres disparus, dont leurs alliés et coéquipiers : récupérer les Pierres d\'Infinité dans le passé.', 'Russo', 'Anthony', 2019, 'https://fr.web.img2.acsta.net/pictures/19/04/04/09/04/0472053.jpg', 0, 0),
('Blade Runner', 117, 'https://www.youtube.com/watch?v=O4C5cwSbXZ8', 'En 2049, la société est fragilisée par les nombreuses tensions entre les humains et leurs esclaves créés par bio-ingénierie. L\'officier K est un blade runner: il fait partie d\'une force d\'intervention d\'élite chargée de trouver et d\'éliminer ceux qui n\'obéissent pas aux ordres des humains. Lorsqu\'il découvre un secret enfoui depuis longtemps et capable de changer le monde, les plus hautes instances décident que c\'est à son tour d\'être traqué et éliminé. Il doit trouver Rick Deckard.', 'Scott', 'Ridley', 1982, 'https://fr.web.img4.acsta.net/pictures/17/08/24/15/18/597734.jpg', 0, 0),
